...
require('packer').startup(function(use)
  ...
  use 'ishan9299/nvim-solarized-lua' -- solarized with lua support
  ...
  use 'ziglang/zig.vim' -- zig file detection and syntax highlights
...
-- My mappings
vim.api.nvim_set_keymap('n', '<leader><space>', [[<cmd>b#<CR>]], { noremap = true, silent = true })
